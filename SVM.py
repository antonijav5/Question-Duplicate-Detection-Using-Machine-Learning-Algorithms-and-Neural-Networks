...
def roc_curve_confusion_matrix_svm(model):
    from sklearn.metrics import roc_curve, auc
    y_prob_test = model.decision_function(X_test_tfidf)
    y_prob_train = model.decision_function(X_train_tfidf)
...
if __name__ == '__main__':
    ...
    roc_curve_confusion_matrix_svm(svm_model)
